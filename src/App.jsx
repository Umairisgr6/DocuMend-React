      ...
      <header className="absolute left-0 right-0 top-0 z-20 text-[#172d26]">
        <div className="container-wide flex h-[82px] items-center justify-between">
          ...
          <nav className="desktop-nav flex items-center gap-8" aria-label="Main navigation">
            ...
            <button type="button" onClick={() => setModalOpen(true)} className="btn-primary ml-1 border border-[#d8a53c] bg-[#d8a53c] px-4 py-2 text-xs font-semibold text-[#172d26]">Get started</button>
          </nav>
        ...
        {menuOpen && (
          <nav className="mx-4 flex flex-col gap-4 border border-[#718478]/30 bg-[#172d26] p-5 md:hidden" aria-label="Mobile navigation">
            ...
            <button type="button" onClick={() => { closeMenu(); setModalOpen(true); }} className="mt-2 self-start bg-[#d8a53c] px-4 py-2 text-xs font-semibold text-[#172d26]">Get started</button>
          </nav>
        )}
      </header>
